...
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to cart_tran_bank0[4]
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to cart_tran_bank0[5]
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to cart_tran_bank0[6]
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to cart_tran_bank0[7]
set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to cart_tran_bank0[4]
set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to cart_tran_bank0[5]
set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to cart_tran_bank0[6]
set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to cart_tran_bank0[7]
set_instance_assignment -name FAST_INPUT_REGISTER ON -to cart_tran_bank0[4]
set_instance_assignment -name FAST_INPUT_REGISTER ON -to cart_tran_bank0[5]
set_instance_assignment -name FAST_INPUT_REGISTER ON -to cart_tran_bank0[6]
set_instance_assignment -name FAST_INPUT_REGISTER ON -to cart_tran_bank0[7]

set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to cart_tran_bank1[0]
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to cart_tran_bank1[1]
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to cart_tran_bank1[2]
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to cart_tran_bank1[3]
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to cart_tran_bank1[4]
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to cart_tran_bank1[5]
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to cart_tran_bank1[6]
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to cart_tran_bank1[7]
set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to cart_tran_bank1[0]
set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to cart_tran_bank1[1]
set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to cart_tran_bank1[2]
set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to cart_tran_bank1[3]
set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to cart_tran_bank1[4]
set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to cart_tran_bank1[5]
set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to cart_tran_bank1[6]
set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to cart_tran_bank1[7]
#set_instance_assignment -name FAST_INPUT_REGISTER ON -to cart_tran_bank1[0]
#set_instance_assignment -name FAST_INPUT_REGISTER ON -to cart_tran_bank1[1]
#set_instance_assignment -name FAST_INPUT_REGISTER ON -to cart_tran_bank1[2]
#set_instance_assignment -name FAST_INPUT_REGISTER ON -to cart_tran_bank1[3]
#set_instance_assignment -name FAST_INPUT_REGISTER ON -to cart_tran_bank1[4]
#set_instance_assignment -name FAST_INPUT_REGISTER ON -to cart_tran_bank1[5]
#set_instance_assignment -name FAST_INPUT_REGISTER ON -to cart_tran_bank1[6]
#set_instance_assignment -name FAST_INPUT_REGISTER ON -to cart_tran_bank1[7]

set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to cart_tran_bank2[0]
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to cart_tran_bank2[1]
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to cart_tran_bank2[2]
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to cart_tran_bank2[3]
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to cart_tran_bank2[4]
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to cart_tran_bank2[5]
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to cart_tran_bank2[6]
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to cart_tran_bank2[7]
set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to cart_tran_bank2[0]
set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to cart_tran_bank2[1]
set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to cart_tran_bank2[2]
set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to cart_tran_bank2[3]
set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to cart_tran_bank2[4]
set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to cart_tran_bank2[5]
set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to cart_tran_bank2[6]
set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to cart_tran_bank2[7]
set_instance_assignment -name FAST_INPUT_REGISTER ON -to cart_tran_bank2[0]
set_instance_assignment -name FAST_INPUT_REGISTER ON -to cart_tran_bank2[1]
set_instance_assignment -name FAST_INPUT_REGISTER ON -to cart_tran_bank2[2]
set_instance_assignment -name FAST_INPUT_REGISTER ON -to cart_tran_bank2[3]
set_instance_assignment -name FAST_INPUT_REGISTER ON -to cart_tran_bank2[4]
set_instance_assignment -name FAST_INPUT_REGISTER ON -to cart_tran_bank2[5]
set_instance_assignment -name FAST_INPUT_REGISTER ON -to cart_tran_bank2[6]
set_instance_assignment -name FAST_INPUT_REGISTER ON -to cart_tran_bank2[7]

set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to cart_tran_bank3[0]
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to cart_tran_bank3[1]
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to cart_tran_bank3[2]
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to cart_tran_bank3[3]
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to cart_tran_bank3[4]
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to cart_tran_bank3[5]
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to cart_tran_bank3[6]
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to cart_tran_bank3[7]
set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to cart_tran_bank3[0]
set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to cart_tran_bank3[1]
set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to cart_tran_bank3[2]
set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to cart_tran_bank3[3]
set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to cart_tran_bank3[4]
set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to cart_tran_bank3[5]
set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to cart_tran_bank3[6]
set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to cart_tran_bank3[7]
set_instance_assignment -name FAST_INPUT_REGISTER ON -to cart_tran_bank3[0]
set_instance_assignment -name FAST_INPUT_REGISTER ON -to cart_tran_bank3[1]
set_instance_assignment -name FAST_INPUT_REGISTER ON -to cart_tran_bank3[2]
set_instance_assignment -name FAST_INPUT_REGISTER ON -to cart_tran_bank3[3]
set_instance_assignment -name FAST_INPUT_REGISTER ON -to cart_tran_bank3[4]
set_instance_assignment -name FAST_INPUT_REGISTER ON -to cart_tran_bank3[5]
